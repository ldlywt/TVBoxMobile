package com.ldlywt.video.osc.player.controller;
...
import com.ldlywt.video.osc.subtitle.widget.SimpleSubtitleView;
import com.ldlywt.video.osc.ui.adapter.SelectDialogAdapter;
import com.ldlywt.video.osc.ui.dialog.SelectDialog;
import com.ldlywt.video.osc.ui.widget.MyBatteryView;
...
import com.ldlywt.video.osc.util.ScreenUtils;
...
//        增加播放页面片头片尾时间重置
    ...
    private void hideLiveAboutBtn() {
        if (mControlWrapper != null && mControlWrapper.getDuration() == 0) {
            ...
            mPlayerSpeedBtn.setVisibility(VISIBLE);
    ...
    public void initLandscapePortraitBtnInfo() {
        if (mControlWrapper != null && mActivity != null) {
            ...
            if (screenSqrt < 10.0 && width < height) {
                mLandscapePortraitBtn.setVisibility(VISIBLE);

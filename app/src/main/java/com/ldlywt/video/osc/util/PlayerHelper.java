...
import com.ldlywt.video.osc.player.render.SurfaceRenderViewFactory;
import com.ldlywt.video.osc.player.thirdparty.Kodi;
import com.ldlywt.video.osc.player.thirdparty.MXPlayer;
import com.ldlywt.video.osc.player.thirdparty.ReexPlayer;
import com.ldlywt.video.osc.player.thirdparty.RemoteTVBox;
import com.ldlywt.video.osc.player.thirdparty.VlcPlayer;
...
public class PlayerHelper {
    public static void updateCfg(VideoView videoView, JSONObject playerCfg) {
        ...
        if (videoView != null && playerFactory != null) {
